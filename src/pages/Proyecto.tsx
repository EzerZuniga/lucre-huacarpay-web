    ...
    <div className="min-h-screen pt-20 bg-wetland-ivory">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-wetland-ink mb-4">Proyecto de Conservación</h1>
            ...
            <ul className="space-y-3">
              {conservationActions.map((action, index) => (
                <li key={index} className="flex items-start">
                  <FiCheckCircle className="text-wetland-lagoon mt-1 mr-3 flex-shrink-0" size={20} />
          ...
          <Card>
            ...
            <div className="space-y-4">
              {impactIndicators.map((indicator, index) => (
                <div key={index} className="bg-wetland-foam p-4 rounded-lg border border-wetland-sand">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-sm font-medium text-wetland-ink-soft">{indicator.metric}</span>
                    <span className="text-sm font-bold text-wetland-earth">{indicator.current} / {indicator.target}</span>
                  </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-wetland-lagoon to-wetland-moss rounded-2xl p-8 text-wetland-foam">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="outline" to={ROUTES.CONTACT} className="border-wetland-foam text-wetland-foam hover:bg-wetland-foam hover:text-wetland-ink">
                Ser Voluntario
              </Button>
