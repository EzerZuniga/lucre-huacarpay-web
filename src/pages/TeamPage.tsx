    ...
    <div className="min-h-screen pt-20 bg-wetland-ivory">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <SectionHeader
          ...
          description="Conoce al equipo comprometido con la conservación y divulgación de la Laguna Huacarpay."
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {TEAM_MEMBERS.map((member) => (
            <Card
              key={member.initials}
              className="flex flex-col h-full hover:transform hover:scale-105 transition-all duration-300"
            >
        ...
        <div className="section-surface p-8 md:p-12">
          <h2 className="text-3xl font-bold mb-8 text-wetland-ink text-center">
